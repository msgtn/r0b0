...
def main():
    ...
    # Create the gadgets
    mpk_mini_plus = r0b0.gadgets.from_config(
        os.path.abspath("../config/gadgets/mpk_mini_plus.yaml")
    )
    open_arm = r0b0.gadgets.from_config(
        os.path.abspath("../config/gadgets/open_arm.yaml")
    )
