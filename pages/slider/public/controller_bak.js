...
function checkPswd() {
  ...
  socket.on("newVideo", (videoName) => {
    ...
    curVideo = videoName;
    ytVid.r0b0 = `https://www.youtube.com/embed/${ytDict[curVideo]}?autoplay=1&modestbranding=1&rel=1`
...
function updateVideo() {
  ...
  ytVid.r0b0 = `https://www.youtube.com/embed/${curId}?autoplay=1&modestbranding=1&rel=1`
